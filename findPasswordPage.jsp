...
<body>
    <main class="findBox">
        ...
        <div class="findPasswordMain">
            <form name="findPasswordForm" action="action/findPasswordAction.jsp">
            <div class="inputBox">
                <span class="inputBoxText">아이디</span>
                <input id="idValue" name="idValue" class="inputBoxInput" type='text' placeholder="6~30 한글,영어" maxlength="30">
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                ...
                <input id="phonenumberValue" name="phonenumberValue" class="inputBoxInput" type='text' placeholder="(-)없이 11자리 숫자"
                    maxlength="11">
            </div>
            </form>
        </div>
        <div class="findFooter">
            <input type="button" class="findButton" value="찾기" onclick="checkFindPassword()">
